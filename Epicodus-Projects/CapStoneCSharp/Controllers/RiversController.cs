...
namespace CapStoneCSharp.Controllers
{
    [Authorize]
    public class RiversController : Controller
    {
        private readonly CapStoneCSharpContext _db;
        private readonly UserManager<ApplicationUser> _userManager;

        public RiversController(UserManager<ApplicationUser> userManager, CapStoneCSharpContext db)
        {
